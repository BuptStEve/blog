...
### 1.1.什么是编程范式？
<img :src="$withBase('/fp-in-js/paradigms_title.png')" alt="paradigms_title">
...
<img :src="$withBase('/fp-in-js/function-sets.gif')" alt="function-sets">

与之相反，下面这张图表展示的就不是一种函数关系，因为输入值 5 指向了多个输出：

<img :src="$withBase('/fp-in-js/relation-not-function.gif')" alt="relation-not-function">
...
<img :src="$withBase('/fp-in-js/the-root-of-all-evil.jpg')" alt="the-root-of-all-evil">
...
<img :src="$withBase('/fp-in-js/shared-mutable-state.jpg')" alt="shared-mutable-state">
...
<img :src="$withBase('/fp-in-js/javascript_functional_lite.png')" alt="javascript_functional_lite">
...
<img :src="$withBase('/fp-in-js/data-type-in-js.png')" alt="data-type-in-js">
...
#### 1.5.4.尾递归优化
<img :src="$withBase('/fp-in-js/tail-calls.png')" alt="tail-calls">
